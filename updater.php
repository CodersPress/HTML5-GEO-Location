...
class WP_HTML5_Updater {
	...
	public function __construct( $config = array() ) {
		...
		if ( ! $this->has_minimum_config() ) {
			$message = 'The HTML5 Updater was initialized without the minimum required configuration, please check the config in your plugin. The following params are missing: ';
	...
	public function overrule_transients() {
		return ( defined( 'WP_HTML5_FORCE_UPDATE' ) && WP_HTML5_FORCE_UPDATE );
	}
